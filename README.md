...
# COS417 Spring 2025: Virtual Memory
...
### Hints
We have added a file named `wmap.h` that defines:
1. A structure that stores wmap info.
2. Defines for various wmap constants. 
...
### Related Readings
- [OSTEP Chapter 18: Introduction to Paging.](https://pages.cs.wisc.edu/~remzi/OSTEP/vm-paging.pdf)
Discusses how paging for VM works in abstract.
